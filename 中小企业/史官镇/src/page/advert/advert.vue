  ...
  export default {
    ...
    methods: {
      ...
      onsubmitedit(event) {
        ...
        this.$axios({
          method: "post",
          url: "/api/sgzadmin/edit_advert/" + this.id,         
          data: formData
        })
          .then(res => {
            if (res.data.status == 1) {
      ...
      handledDel(index, row) {
        this.$axios({
          method: "post",
          url: "/api/sgzadmin/del_advert/" + row.id,          
        })
          .then(res => {
