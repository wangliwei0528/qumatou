...
export default {
  ...
  methods: {
    ...
    editpass(index, row) {
      ...
      this.$axios({
        method: "get",
        url: "/api/sgzadmin/user_info/" + this.id,
    ...
    onSubmitedit() {
      this.$axios({
        method: "POST",
        url: "/api/sgzadmin/edit_password/" + this.id,
    ...
    setGroup(index, row) {
      ...
      this.$axios({
        method: "get",
        url: "/api/sgzadmin/user_info/" + row.id,
        headers: {
    ...
    onSubmitset() {
      this.$axios({
        method: "POST",
        url: "/api/sgzadmin/setup_user/" + this.id,
    ...
    blockedUser(index, row) {
      ...
      this.$axios({
        method: "POST",
        url: "/api/sgzadmin/closure_user/" + row.id,
